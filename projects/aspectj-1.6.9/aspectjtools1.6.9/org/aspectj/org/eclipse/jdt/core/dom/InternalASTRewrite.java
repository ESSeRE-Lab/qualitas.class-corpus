...
class InternalASTRewrite extends NodeEventHandler {
	...
	public TextEdit rewriteAST(IDocument document, Map options) {
		...
		if (rootNode != null) {
			...
			// new code:
			ASTVisitor visitor = ASTRewriteAnalyzer.getAnalyzerVisitor(content, lineInfo, lineDelim, result, this.eventStore, this.nodeStore, comments, options, xsrComputer);
