 ...
 * @author tom
 */
public class AlphaColorJMenuItem extends JMenuItem implements ChangeListener, ActionListener, AlphaColorButtonI
{
    private SolidColoredIcon fill_icon_ = null;
    private String title = "Choose Color";

    public AlphaColorJMenuItem(Color color)
    {
    ...
    public AlphaColorJMenuItem( IIconFactory icon_provider, String name, Color color )
    {
        super();
