 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class GradientJButton extends JRadioButton implements ChangeListener, ActionListener
{
	private GradientIcon gradient_icon_;
	private String title_ = "Choose Color";

	public GradientJButton(MultipleGradientPaint gradient)
	{
	...
	public GradientJButton(IIconFactory icon_provider, String name, MultipleGradientPaint gradient)
	{
		this(icon_provider, name);
		gradient_icon_.setGradient(gradient);
	}

	public GradientJButton(IIconFactory icon_provider, String name)
	{
		super();
