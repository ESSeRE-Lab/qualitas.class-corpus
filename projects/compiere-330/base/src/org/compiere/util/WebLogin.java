 ...
 *
 *  @author Yves Sandfort, Jorg Janke
 *  @version $Id$
 */
public class WebLogin
{
	/**	Logger	*/
    private static CLogger log = CLogger.getCLogger(WebLogin.class);
	 ...
	 *	@param t_ctx
	 */
	public WebLogin (HttpServletRequest t_request, HttpServletResponse t_response, Ctx t_ctx)
	{
		m_request = t_request;
