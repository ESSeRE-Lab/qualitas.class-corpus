...
public class MClick extends X_W_Click
{
	 ...
	 */
	public static MClick[] getUnprocessed(Ctx ctx)
	{
	 ...
	 */
	public MClick (Ctx ctx, int W_Click_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
	public MClick (Ctx ctx, String TargetURL, Trx trx)
	{
		this (ctx, 0, trx);
	 ...
	 *	@param trx transaction
	 */
	public MClick (Ctx ctx, ResultSet rs, Trx trx)
	{
		super (ctx, rs, trx);
	}	//	MClick
