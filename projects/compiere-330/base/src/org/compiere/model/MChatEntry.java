...
public class MChatEntry extends X_CM_ChatEntry
{
	 ...
	 */
	public MChatEntry (Ctx ctx, int CM_ChatEntry_ID, Trx trx)
	{
	...
	{
		this (chat.getCtx(), 0, chat.get_Trx());
	...
	{
		this (peer.getCtx(), 0, peer.get_Trx());
	 ...
	 *	@param trx transaction
	 */
	public MChatEntry (Ctx ctx, ResultSet rs, Trx trx)
	{
		super (ctx, rs, trx);
	}	//	MChatEntry
