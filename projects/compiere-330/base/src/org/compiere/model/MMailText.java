...
public class MMailText extends X_R_MailText
{
	 ...
	 */
	public MMailText(Ctx ctx, int R_MailText_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
	public MMailText (Ctx ctx, ResultSet rs, Trx trx)
	{
		super (ctx, rs, trx);
	}	//	MMailText
	...
	/** Translation Cache	*/
	private static final CCache<String,MMailTextTrl> s_cacheTrl = new CCache<String,MMailTextTrl> ("", 20);
