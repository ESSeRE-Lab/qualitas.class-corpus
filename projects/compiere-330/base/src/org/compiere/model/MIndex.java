...
public class MIndex extends X_K_Index
{
	 ...
	 */
	public MIndex (Ctx ctx, int K_Index_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
	public MIndex (Ctx ctx, ResultSet rs, Trx trx)
	{
		super (ctx, rs, trx);
	}	//	MIndex
	 ...
	 */
	public static int cleanUp (Trx trx, int AD_Client_ID, int AD_Table_ID, int Record_ID)
	{
	 ...
	 *	@param ctx context
	 *	@param trx Transaction if needed
	 ...
	 */
	public static boolean runIndex(String thisText, Ctx ctx, Trx trx, 
	 ...
	 */
	public static void reIndex(boolean runCleanUp, String[] toBeIndexed, Ctx ctx, 
	...
	public static MIndex[] getResults(String query, Ctx ctx, Trx trx) 
	{
