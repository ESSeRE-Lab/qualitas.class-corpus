...
public class MImage extends X_AD_Image
{
	...
	/**	Cache						*/
	private static final CCache<Integer,MImage> s_cache = new CCache<Integer,MImage>("AD_Image", 20);
	 ...
	 */
	public MImage(Ctx ctx, int AD_Image_ID, Trx trx)
	{
	 ...
	 *  @param trx transaction
	 */
	public MImage (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}	//	MImage
