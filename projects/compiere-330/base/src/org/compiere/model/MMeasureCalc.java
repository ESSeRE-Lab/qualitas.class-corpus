...
public class MMeasureCalc extends X_PA_MeasureCalc {
	...
	/** Cache */
	private static final CCache<Integer, MMeasureCalc> s_cache = new CCache<Integer, MMeasureCalc>(
			"PA_MeasureCalc", 10);
	 ...
	 *            p_trx
	 */
	public MMeasureCalc(Ctx ctx, int PA_MeasureCalc_ID, Trx trx) {
	 ...
	 *            p_trx
	 */
	public MMeasureCalc(Ctx ctx, ResultSet rs, Trx trx) {
		super(ctx, rs, trx);
	} // MMeasureCalc
	 ...
	 * @return updated sql
	 */
	private String addRestrictions(String sql, MGoalRestriction[] restrictions,
			MRole role) {
	 ...
	 *            orig sql
	 * @param queryOnly
	 *            incomplete sql for query restriction
	 * @param restrictions
	 *            restrictions
	 * @param role
	 *            role
