 ...
 */
public class MRfQResponseLineQty extends X_C_RfQResponseLineQty implements Comparator<PO>
{
	/**
	 * 
	 */
	 ...
	 */
	public MRfQResponseLineQty (Ctx ctx, int C_RfQResponseLineQty_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
	public MRfQResponseLineQty (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}	//	MRfQResponseLineQty
