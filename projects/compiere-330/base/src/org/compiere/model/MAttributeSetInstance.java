...
public class MAttributeSetInstance extends X_M_AttributeSetInstance
{
	 ...
	 */
	public MAttributeSetInstance (Ctx ctx, int M_AttributeSetInstance_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
	public MAttributeSetInstance (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}	//	MAttributeSetInstance
	...
	public MAttributeSetInstance (Ctx ctx, int M_AttributeSetInstance_ID, 
		int M_AttributeSet_ID, Trx trx)
	{
		this (ctx, M_AttributeSetInstance_ID, trx);
	...
	/**	Date Format					*/
	private DateFormat			m_dateFormat = DisplayType.getDateFormat(DisplayTypeConstants.Date);
