 ...
 */
 public class MBankStatementLoader extends X_C_BankStatementLoader
 {
	 ...
	 */
	public MBankStatementLoader(Ctx ctx, int C_BankStatementLoader_ID, Trx trx)
	{
	 ...
	 *	@param trx transaction
	 */
 	public MBankStatementLoader(Ctx ctx, int C_BankStatementLoader_ID, String fileName, Trx trx)
	{
		super(ctx, C_BankStatementLoader_ID, trx);
		init(fileName);
	 ...
	 *	@param trx transaction
	 */
 	public MBankStatementLoader(Ctx ctx, ResultSet rs, Trx trx)
 	{
 		super(ctx, rs, trx);
 		init(null);
 	}	//	MBankStatementLoader
