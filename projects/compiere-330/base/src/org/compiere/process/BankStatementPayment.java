...
public class BankStatementPayment extends SvrProcess
{
	...
	/** TenderType				*/
	private String		p_TenderType = X_C_Payment.TENDERTYPE_DirectDebit;
	/** RoutingNo				*/
	private String		p_RoutingNo = null;
	/** AccountNo			*/
	private String		p_AccountNo = null;
	/** CheckNo			*/
	private String		p_CheckNo = null;
	/** Micr		*/
	private String		p_Micr = null;
	/** Account Name */
	private String		p_A_Name = null;
