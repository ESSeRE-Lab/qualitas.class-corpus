...
@Title Import Compiere DB (Reference) - %COMPIERE_HOME% (%COMPIERE_DB_NAME%) - %COMPIERE_DB_USER%

@echo Re-Create Compiere DB User and import from Reference %COMPIERE_HOME%\data - (%COMPIERE_DB_NAME%)
@dir ..\data\CompiereReferenceDev1.dmp
...
@echo -------------------------------------
imp system/%COMPIERE_DB_SYSTEM%@%COMPIERE_DB_NAME% FILE=..\data\CompiereReferenceDev1.dmp FROMUSER=(reference) TOUSER=%COMPIERE_DB_USER% STATISTICS=RECALCULATE
