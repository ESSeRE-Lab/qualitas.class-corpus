...
public class PrintDataFunction
{
	...
	static public int getFunctionDisplayType (char function, int displayType)
	{
		...
		{
			if ( displayType == DisplayTypeConstants.Quantity )
				return DisplayTypeConstants.Quantity;
			else if ( displayType == DisplayTypeConstants.CostPrice )
				return DisplayTypeConstants.CostPrice;
			else if ( displayType == DisplayTypeConstants.Integer )
				return DisplayTypeConstants.Integer;		
			else
				return DisplayTypeConstants.Amount;
		}
		if (function == F_COUNT)
			return DisplayTypeConstants.Integer;
		//	Mean, Variance, Std. Deviation 
		return DisplayTypeConstants.Number;
	}	//	getFunctionName
