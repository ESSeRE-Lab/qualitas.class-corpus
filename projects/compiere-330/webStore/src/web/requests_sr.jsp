...
<div id="main">
	...
	<h1>Assigned Requests</h1>
      ...
      <table class="contentTable">
        ...
        <tr> 
          <td class="<c:out value='${rowClass}' />"><a href="requestDetails.jsp?R_Request_ID=<c:out value='${request.r_Request_ID}'/>&ForwardTo=requests_sr.jsp"><c:out value='${request.documentNo}'/></a></td>
