...
FROM AD_Ref_Table rt
  ...
  INNER JOIN AD_Column ck ON (ck.AD_Column_ID=rt.Column_Key_ID AND ck.AD_Table_ID!=rt.AD_Table_ID)
  INNER JOIN AD_Column cd ON (cd.AD_Column_ID=rt.Column_Key_ID AND cd.AD_Table_ID!=rt.AD_Table_ID);
