 ...
 *
SELECT Name, Value, Description, IsDefault, Update_Comment FROM v$parameter 
...
WHERE Name LIKE '%_pool_size' OR Name LIKE 'sga% ORDER BY 1
/
...
/
ALTER SYSTEM SET processes=600 COMMENT='Compiere' SCOPE=SPFILE;
/
