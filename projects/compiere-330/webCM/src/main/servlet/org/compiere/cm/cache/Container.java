...
public class Container extends CO {
	...
	protected Hashtable<String, String> cacheContainerURL = new Hashtable<String, String>(cacheSize);
	...
	public MContainer getCM_Container(int ID, int CM_WebProject_ID) {
		if (cache.containsKey(ID)) {
			...
			MContainer thisContainer = MContainer.get(ctx, ID, CM_WebProject_ID, HttpServletCM.getTrx());
	...
	public MContainer getCM_ContainerByURL(String URL, int CM_WebProject_ID, boolean resolveURLErrors) {
		if (cacheContainerURL.containsKey(CM_WebProject_ID + "-" + URL)) {
			...
			MContainer thisContainer = getCM_Container(cacheContainerURL.get(CM_WebProject_ID + "-" + URL), CM_WebProject_ID);
			...
			MContainer thisContainer = MContainer.get (ctx, URL, CM_WebProject_ID, HttpServletCM.getTrx());
			if (thisContainer==null) {
				if (resolveURLErrors) {
