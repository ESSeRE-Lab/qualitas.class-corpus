	...
	implements ActionListener
{
	...
	private VDate fDateFrom = new VDate(DisplayTypeConstants.DateTime);
	...
	private void setDisplay()
	{
		...
		for (KeyNamePair element : resources) {
			if (element.getKey() == S_Resource_ID)
			{
				fResource.setSelectedItem(element);
				break;
			}
		}
