	...
	implements ChangeListener, ActionListener, KeyListener
{
	 ...
	 */
	public static String startEditor(Container jc, String header, String text, boolean editable, int maxSize, String vFormat)
	{
		//	Find frame
		...
		if( vFormat != null && !vFormat.equals(""))
			ed.textArea.getTextArea().setDocument( new MDocString( vFormat, maxSize, ed.textArea.getTextArea()));
