...
public class SubCurrentLine extends PosSubPanel implements ActionListener
{
	...
	public void init()
	{
		...
		add (f_currency, gbc);
		//
		f_price = new VNumber("PriceActual", false, false, true, DisplayTypeConstants.Amount, 
		...
		add (f_minus, gbc);
		//
		f_quantity = new VNumber("QtyOrdered", false, false, true, DisplayTypeConstants.Quantity, 
