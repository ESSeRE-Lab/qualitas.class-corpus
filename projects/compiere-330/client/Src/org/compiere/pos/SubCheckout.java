...
public class SubCheckout extends PosSubPanel implements ActionListener
{
	...
	public void init()
	{
		...
		f_cashGiven = new VNumber("CashGiven", false, false, true, DisplayTypeConstants.Amount, 
		...
		f_cashReturn = new VNumber("CashReturn", false, true, false, DisplayTypeConstants.Amount, 
			"CashReturn");
