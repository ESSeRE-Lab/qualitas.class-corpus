...
public class SubLines extends PosSubPanel implements ActionListener
{
	...
	//	m_table.getSelectionModel().addListSelectionListener(this);
		...
		summary.add(lNet);
		f_net = new VNumber("TotalLines", false, true, false, DisplayTypeConstants.Amount, "TotalLines");
		...
		summary.add(lTax);
		f_tax = new VNumber("TaxAmt", false, true, false, DisplayTypeConstants.Amount, "TaxAmt");
		...
		summary.add(lTotal);
		f_total = new VNumber("GrandTotal", false, true, false, DisplayTypeConstants.Amount, "GrandTotal");
	...
	public void updateTable (MOrder order)
	{
		...
		try
		{
			pstmt = DB.prepareStatement(m_sql, (Trx) null);
