	...
	implements FormPanel, ActionListener
{
	...
	private void jbInit() throws Exception
	{
		...
		centerPanel.add(fPaySelect,    new GridBagConstraints(1, 0, 3, 1, 0.0, 0.0
	...
	private void dynInit()
	{
		...
		String sql = "SELECT C_PaySelection_ID, Name || ' - ' || " + DB.TO_CHAR("TotalAmt", DisplayTypeConstants.Number, Env.getAD_Language(Env.getCtx())) + " FROM C_PaySelection "
	...
	private void loadPaymentRuleInfo()
	{
		...
		try
		{
			...
			//
			if (rs.next())
				fDocumentNo.setValue(Integer.valueOf(rs.getInt(1)));
			else
			{
