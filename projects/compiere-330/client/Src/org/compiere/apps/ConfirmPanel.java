...
public final class ConfirmPanel extends CPanel
{
	...
	/************************
	 *	Create Reset Button with label text
	 *  @param text text
	 *  @return button
	 */
	...
	/**
	 *	Create Reset Button with Standard text
	 *  @param withText with text
	 *  @return Button
	 */
	...
	/************************
	 *	Create Customize Button with label text
	 *  @param text text
	 *  @return button
	 */
	...
	/**
	 *	Create Customize Button with Standard text
	 *  @param withText with text
	 *  @return Button
	 */
	...
	/************************
	 *	Create History Button with label text
	 *  @param text text
	 *  @return button
	 */
	...
	/**
	 *	Create History Button with Standard text
	 *  @param withText with text
	 *  @return Button
	 */
	...
	/**
	 *	Create Zoom Button with Standard text
	 *  @param withText with text
	 *  @return Button
	 */
	...
	public static final CButton createProcessButton (String text)
	{
		AppsAction aa = new AppsAction (A_PROCESS, 
			KeyStroke.getKeyStroke(KeyEvent.VK_F4, InputEvent.SHIFT_MASK), text);
		CButton button = (CButton)aa.getButton();
		button.setMargin(s_insets);
		return button;
	}	//	createProcessButton
	...
	/************************
	 *	Create Print Button with label text
	 *  @param text text
	 *  @return button
	 */
	...
	/************************
	 *	Create Help Button with label text
	 *  @param text text
	 *  @return Button
	 */
	...
	/************************
	 *	Create Save Button with label text
	 *  @param text text
	 *  @return Button
	 */
	public static final CButton createSaveButton (String text)
	{
		AppsAction aa = new AppsAction (A_SAVE, KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.SHIFT_MASK), text);
		CButton button = (CButton)aa.getButton();
		button.setMargin(s_insets);
		return button;
	}	//	createSaveButton
	 ...
	 *  @return Button
	 */
	public static final CButton createSaveButton (boolean withText)
	{
		if (withText)
			return createSaveButton(Msg.getMsg(Env.getCtx(), A_SAVE));
		return createSaveButton(null);
	}	//	createSaveButton

	/************************
	 *	Create Export Button with label text
	 *  @param text text
	 *  @return Button
	 */
