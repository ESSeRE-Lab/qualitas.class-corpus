...
public class InfoAsset extends Info
{
	...
	public static final Info_Column[] s_assetLayout = {
	...
	private void statInit()
	{
		...
		fBPartner_ID = new VLookup("C_BPartner_ID", false, false, true,
			MLookupFactory.get (Env.getCtx(), p_WindowNo, 8065, DisplayTypeConstants.Search));
		lBPartner_ID.setLabelFor(fBPartner_ID);
		fBPartner_ID.setBackground(CompierePLAF.getInfoBackground());
		fProduct_ID = new VLookup("M_Product_ID", false, false, true,
			MLookupFactory.get (Env.getCtx(), p_WindowNo, 8047, DisplayTypeConstants.Search));
	...
	public void saveSelectionDetail()
	{
		...
		Ctx ctx = Env.getCtx();
		ctx.setContext(EnvConstants.WINDOW_INFO, EnvConstants.TAB_INFO, "A_Asset_ID", ID == null ? "0" : ID.toString());
	}   //  saveSelectionDetail
