 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: ImageFactory.java,v 1.3 2006/07/30 00:51:28 jjanke Exp $
 */
public class ImageFactory
{
	 ...
	 *  18*18 Home Icon
	 */
	static class HomeIcon implements Icon, UIResource
	{
		/**
		 * 	Paint Icon
		 *	@param c
		...
		public void paintIcon(Component c, Graphics g, int x, int y)
		{
			...
			g.setColor(MetalLookAndFeel.getControlInfo());           //  black
			...
			// Draw roof body
			g.setColor(MetalLookAndFeel.getControlDarkShadow());     //  secondary1
			...
			// Paint the house
			g.setColor(MetalLookAndFeel.getPrimaryControl());        //  primary3
	...
	/** Folder Icon **********************************************************/
	static Icon				s_FolderIcon = null;
	/** 16*16 dimension     */
	static final Dimension	s_icon16Size = new Dimension(16, 16);
	 ...
	 */
	static class FolderIcon extends FolderIcon16
	{
		/**
		 * 	Get Shift
		 *	@return -1
	...
	public static class FolderIcon16 implements Icon
	{
		...
		private void paintMe(Component c, Graphics g)
		{
			...
			// Draw tab top
			g.setColor(MetalLookAndFeel.getPrimaryControlDarkShadow());  //  primary1
			...
			g.fillRect(2, 7, 13, 8);
			// Draw tab bottom
			g.setColor(MetalLookAndFeel.getPrimaryControlShadow());      //  primary2
			g.drawLine(right - 6, 5, right - 1, 5);
			// Draw outline
			g.setColor(MetalLookAndFeel.getPrimaryControlInfo());        //  black
			...
			// Draw highlight
			g.setColor(MetalLookAndFeel.getPrimaryControlHighlight());   //  white
