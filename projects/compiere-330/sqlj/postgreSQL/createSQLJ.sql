 ...
 *	$Header: /cvs/compiere/sqlj/oracle/createSQLJ.sql,v 1.1 2006/04/21 18:04:47 jjanke Exp $
 */
...
/
CREATE OR REPLACE FUNCTION compiereProperty(VARCHAR)
 	RETURN VARCHAR
 	LANGUAGE JAVA 
...
/** General	**/
BEGIN
	dbms_java.grant_permission(UPPER('&1'),'SYS:java.util.PropertyPermission', '*', 'read,write');
END;
/
