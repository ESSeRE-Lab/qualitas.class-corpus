...
public class CCache<K,V> implements CacheInterface	//, Map<K, V>
{
	...
	{
		this (tableName, initialCapacity, 120, resetAll, null);
	}	//	CCache
	...
	{
		StringBuffer sb = new StringBuffer("CCache[")
			.append(m_tableName)
	...
	public V put (K key, V value)
	{
		expire();
		m_justReset = false;
	//	if (value instanceof PO)		// changes ctx of underlying - if then it should be copied.
	//		((PO)value).set_ROCtx();
