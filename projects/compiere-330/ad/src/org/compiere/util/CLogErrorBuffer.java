...
public class CLogErrorBuffer extends Handler
{
	 ...
	 */	
	public Vector<String> getColumnNames(Ctx ctx)
	{
	 ...
	 *	@return error info
	 */
	public String getErrorInfo (Ctx ctx, boolean errorsOnly)
	{
