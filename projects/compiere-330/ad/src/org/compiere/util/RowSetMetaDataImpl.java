...
public class RowSetMetaDataImpl implements RowSetMetaData,  Serializable {
    ...
    private void checkColType(int SQLType) throws SQLException {
        try {
            Class<Types> c = java.sql.Types.class;
            Field[] publicFields = c.getFields();        
            int fieldValue = 0;
            for (Field element : publicFields) {              
                fieldValue = element.getInt(c);                
    ...
    public String getColumnClassName(int columnIndex) throws SQLException {
        ...
        case Types.INTEGER:
            className = (Integer.valueOf(0)).getClass().getName ();
            break;
    ...
    class ColInfo implements Serializable 
    {
        /**
		 * 
		 */
