...
public class SetupRes extends ListResourceBundle
{
	...
	{ "NewSecurityKey",			"Your new Security Key (lib/CompiereSecure.properties)\n"
	...
	{ "ServerInstall",			"File Installation" },
	...
	{ "ErrorComponent",			"Selected Application(s) issue - see log" },
	{ "SelectComponent",		"Select Applications" },
	{ "SelectComponentInfo",	"Select the Applications to install" },
	{ "AddComponent",			"Add Application" },
