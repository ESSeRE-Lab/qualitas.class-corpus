 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: CompiereColor.java,v 1.2 2006/07/30 00:52:24 jjanke Exp $
 */
public class CompiereColor implements Serializable
{
	...
	/** Names   */
	private static ResourceBundle   s_res = ResourceBundle.getBundle("org.compiere.translate.PlafRes");
	...
	private Color   		m_secondaryColor = new Color (102, 153, 255);
	...
	private float   		m_compositeAlpha = 0.9f;
	...
	/** Gradient Starting point - Default: NORTH   */
	int     		m_startPoint = SwingConstants.NORTH;
	/** Gradient repeat distance in points - Default: 1000   */
	int     		m_repeatDistance = 1000;
