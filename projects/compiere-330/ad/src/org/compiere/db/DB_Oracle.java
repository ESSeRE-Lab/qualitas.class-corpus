 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: DB_Oracle.java 7250 2009-02-26 07:17:05Z freyes $
 */
			...
			try {
				...
				if (USE_CACHE) {
					...
					if (Ini.isClient()) {
						...
						cacheProperties.setProperty("MaxLimit", "6");
						cacheProperties.setProperty("InactivityTimeout", "180"); 
					} else {
						// Server settings
						...
						//cacheProperties.setProperty("AbandonedConnectionTimeout", "1800");
					}
