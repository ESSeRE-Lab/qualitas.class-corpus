...
public class X_C_Order extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27510377706789L;
    /** Last Updated Timestamp 2008-12-02 13:13:10.0 */
    public static final long updatedMS = 1228252390000L;
    /** AD_Table_ID=259 */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isOrderTypeValid(String test)
    {
         return X_Ref_C_DocType_SubTypeSO.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPriorityRuleValid(String test)
    {
         return X_Ref__PriorityRule.isValid(test);
