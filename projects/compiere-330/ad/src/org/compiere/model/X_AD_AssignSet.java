...
public class X_AD_AssignSet extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_AssignSet");
    ...
    public static boolean isAutoAssignRuleValid(String test)
    {
         return X_Ref_AD_AssignSet_Rule.isValid(test);
