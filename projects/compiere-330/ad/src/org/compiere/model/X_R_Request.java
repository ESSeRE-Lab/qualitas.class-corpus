...
public class X_R_Request extends PO
{
    ...
    */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isConfidentialTypeEntryValid(String test)
    {
         return X_Ref_R_Request_Confidential.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDueTypeValid(String test)
    {
         return X_Ref_R_Request_Due_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isNextActionValid(String test)
    {
         return X_Ref_R_Request_Next_Action.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPriorityValid(String test)
    {
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPriorityUserValid(String test)
    {
         return X_Ref__PriorityRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTaskStatusValid(String test)
    {
         return X_Ref_R_Request_TaskStatus.isValid(test);
