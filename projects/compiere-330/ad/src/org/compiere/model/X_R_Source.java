...
public class X_R_Source extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"R_Source");
    ...
    public static final int SOURCECREATETYPE_AD_Reference_ID=423;
    /** Both = B */
    ...
    public static boolean isSourceCreateTypeValid(String test)
    {
         return X_Ref_R_Source_CreateType.isValid(test);
