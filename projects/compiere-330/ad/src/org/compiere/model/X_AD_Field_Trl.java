...
public class X_AD_Field_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Field_Trl_ID id
    @param trx transaction
    */
    public X_AD_Field_Trl (Ctx ctx, int AD_Field_Trl_ID, Trx trx)
    {
        super (ctx, AD_Field_Trl_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Field_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=127 */
    public static final int Table_ID=127;
    
    /** TableName=AD_Field_Trl */
    public static final String Table_Name="AD_Field_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Field_Trl");
