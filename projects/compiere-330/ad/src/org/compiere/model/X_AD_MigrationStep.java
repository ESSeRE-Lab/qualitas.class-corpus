...
public class X_AD_MigrationStep extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_MigrationStep");
    ...
    public static final int DBTYPE_AD_Reference_ID=426;
    /** IBM DB/2 = D */
    ...
    public static boolean isDBTypeValid(String test)
    {
         return X_Ref__Database_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTimingTypeValid(String test)
    {
         return X_Ref_AD_MigrationStep_Timing_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTypeValid(String test)
    {
         return X_Ref_AD_Validation_Rule_Types.isValid(test);
