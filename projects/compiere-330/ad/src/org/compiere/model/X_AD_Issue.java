...
public class X_AD_Issue extends PO
{
    ...
    */
    ...
    public static boolean isIsReproducibleValid(String test)
    {
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsVanillaSystemValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIssueSourceValid(String test)
    {
         return X_Ref_AD_Menu_Action.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isSystemStatusValid(String test)
    {
         return X_Ref_AD_System_Status.isValid(test);
