...
public class X_C_AcctSchema extends PO
{
    ...
    */
    ...
    public static boolean isCommitmentTypeValid(String test)
    {
         return X_Ref_C_AcctSchema_CommitmentType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isCostingLevelValid(String test)
    {
         return X_Ref_C_AcctSchema_CostingLevel.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isGAAPValid(String test)
    {
         return X_Ref_C_AcctSchema_GAAP.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTaxCorrectionTypeValid(String test)
    {
         return X_Ref_C_AcctSchema_TaxCorrectionType.isValid(test);
