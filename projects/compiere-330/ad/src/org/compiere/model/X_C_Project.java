...
public class X_C_Project extends PO
{
    ...
    */
    ...
    public static boolean isProjInvoiceRuleValid(String test)
    {
         return X_Ref_C_Project_InvoiceRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isProjectCategoryValid(String test)
    {
         return X_Ref_C_ProjectType_Category.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isProjectLineLevelValid(String test)
    {
         return X_Ref_C_Project_LineLevel.isValid(test);
