...
public class X_AD_AssignTarget extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_AssignTarget");
    ...
    public static final int AD_TARGETCOLUMN_ID_AD_Reference_ID=414;
    /** Set Target Column.
    ...
    public static final int ASSIGNRULE_AD_Reference_ID=425;
    /** Always = A */
    ...
    public static boolean isAssignRuleValid(String test)
    {
         return X_Ref_AD_AssignTarget_Rule.isValid(test);
