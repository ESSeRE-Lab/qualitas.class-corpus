...
public class X_AD_WF_Node extends PO
{
    ...
    */
    ...
    public static boolean isActionValid(String test)
    {
         return X_Ref_WF_Action.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDynPriorityUnitValid(String test)
    {
    ...
    /** WF Responsible = R */
    public static final String EMAILRECIPIENT_WFResponsible = X_Ref_AD_WF_Node_EMailRecipient.WF_RESPONSIBLE.getValue();
    /** Is test a valid value.
    @param test testvalue
    @return true if valid **/
    public static boolean isEMailRecipientValid(String test)
    {
         return X_Ref_AD_WF_Node_EMailRecipient.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isFinishModeValid(String test)
    {
         return X_Ref_WF_Start_Finish_Mode.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isJoinElementValid(String test)
    {
         return X_Ref_WF_Join_Split.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isSplitElementValid(String test)
    {
         return X_Ref_WF_Join_Split.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isStartModeValid(String test)
    {
         return X_Ref_WF_Start_Finish_Mode.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isSubflowExecutionValid(String test)
    {
         return X_Ref_WF_SubFlow_Execution.isValid(test);
