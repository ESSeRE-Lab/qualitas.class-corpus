...
public class X_M_InOutStage extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27504509179789L;
    /** Last Updated Timestamp 2008-09-25 16:04:23.0 */
    public static final long updatedMS = 1222383863000L;
    /** AD_Table_ID=1015 */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"M_InOutStage");
    ...
    public static boolean isCreateInOutDocActionValid(String test)
    {
    ...
    {
        if (!isCreateInOutDocActionValid(CreateInOutDocAction))
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsInOutCreatedValid(String test)
    {
    ...
    public void setIsInOutCreated (String IsInOutCreated)
    {
        ...
        if (!isIsInOutCreatedValid(IsInOutCreated))
