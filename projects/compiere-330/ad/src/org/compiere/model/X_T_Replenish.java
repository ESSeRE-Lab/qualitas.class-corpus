...
public class X_T_Replenish extends PO
{
    ...
    */
    ...
    public static boolean isReplenishTypeValid(String test)
    {
         return X_Ref_M_Replenish_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isReplenishmentCreateValid(String test)
    {
         return X_Ref_M_Replenishment_Create.isValid(test);
