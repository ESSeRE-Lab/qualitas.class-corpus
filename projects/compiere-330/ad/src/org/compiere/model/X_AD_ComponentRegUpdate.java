...
public class X_AD_ComponentRegUpdate extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_ComponentRegUpdate");
    ...
    public static boolean isIsApprovedValid(String test)
    {
    ...
    {
        if (!isIsApprovedValid(IsApproved))
    ...
    /** IsPublished AD_Reference_ID=319 */
    public static final int ISPUBLISHED_AD_Reference_ID=319;
    /** No = N */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsPublishedValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    {
        if (!isIsPublishedValid(IsPublished))
