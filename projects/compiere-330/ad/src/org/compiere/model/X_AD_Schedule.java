...
public class X_AD_Schedule extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Schedule");
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isScheduleTypeValid(String test)
    {
         return X_Ref_AD_Schedule_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isWeekDayValid(String test)
    {
