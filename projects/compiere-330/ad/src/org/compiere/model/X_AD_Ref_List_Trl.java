...
public class X_AD_Ref_List_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Ref_List_Trl_ID id
    @param trx transaction
    */
    public X_AD_Ref_List_Trl (Ctx ctx, int AD_Ref_List_Trl_ID, Trx trx)
    {
        super (ctx, AD_Ref_List_Trl_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (AD_Ref_List_Trl_ID == 0)
        {
            setAD_Language (null);
            setAD_Ref_List_ID (0);
    ...
    @param trx transaction
    */
    public X_AD_Ref_List_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=136 */
    public static final int Table_ID=136;
    
    /** TableName=AD_Ref_List_Trl */
    public static final String Table_Name="AD_Ref_List_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Ref_List_Trl");
