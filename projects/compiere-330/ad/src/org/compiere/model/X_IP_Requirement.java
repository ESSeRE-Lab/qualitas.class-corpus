...
public class X_IP_Requirement extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"IP_Requirement");
    ...
    public static boolean isRequirementTypeValid(String test)
    {
         return X_Ref_IP_Requirement_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTaskTypeValid(String test)
    {
         return X_Ref_C_Task_Type.isValid(test);
