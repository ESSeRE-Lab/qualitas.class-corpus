...
public class X_M_DiscountSchema extends PO
{
    ...
    */
    ...
    public static boolean isCumulativeLevelValid(String test)
    {
         return X_Ref_M_Discount_CumulativeLevel.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDiscountTypeValid(String test)
    {
         return X_Ref_M_Discount_Type.isValid(test);
