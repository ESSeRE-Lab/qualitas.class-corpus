...
public class X_PA_Measure extends PO
{
    ...
    */
    ...
    public static boolean isMeasureDataTypeValid(String test)
    {
         return X_Ref_PA_Measure_DataType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isMeasureTypeValid(String test)
    {
         return X_Ref_PA_Measure_Type.isValid(test);
