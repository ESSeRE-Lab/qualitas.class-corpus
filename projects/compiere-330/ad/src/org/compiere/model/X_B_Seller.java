...
public class X_B_Seller extends PO
{
    ...
    */
    public X_B_Seller (Ctx ctx, int B_Seller_ID, Trx trx)
    {
        super (ctx, B_Seller_ID, trx);
    ...
    @param trx transaction
    */
    public X_B_Seller (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    {
        set_Value ("IsInternal", Boolean.valueOf(IsInternal));
    ...
    {
        return get_ValueAsBoolean("IsInternal");
