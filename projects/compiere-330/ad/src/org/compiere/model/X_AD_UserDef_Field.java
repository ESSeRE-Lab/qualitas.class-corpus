...
public class X_AD_UserDef_Field extends PO
{
    ...
    */
    ...
    public static boolean isIsDisplayedValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsMandatoryUIValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsReadOnlyValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsSameLineValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsSelectionColumnValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    public static final int ISSUMMARYCOLUMN_AD_Reference_ID=319;
    /** No = N */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsSummaryColumnValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsUpdateableValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
