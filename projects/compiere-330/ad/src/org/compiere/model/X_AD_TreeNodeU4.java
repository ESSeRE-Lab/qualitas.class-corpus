...
public class X_AD_TreeNodeU4 extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_TreeNodeU4_ID id
    @param trx transaction
    */
    public X_AD_TreeNodeU4 (Ctx ctx, int AD_TreeNodeU4_ID, Trx trx)
    {
        super (ctx, AD_TreeNodeU4_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_TreeNodeU4 (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_TreeNodeU4");
