...
/** Generated Model for AD_Process_Para_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_AD_Process_Para_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Process_Para_Trl_ID id
    @param trx transaction
    */
    public X_AD_Process_Para_Trl (Ctx ctx, int AD_Process_Para_Trl_ID, Trx trx)
    {
        super (ctx, AD_Process_Para_Trl_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (AD_Process_Para_Trl_ID == 0)
        {
            setAD_Language (null);
    ...
    @param trx transaction
    */
    public X_AD_Process_Para_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=286 */
    public static final int Table_ID=286;
    
    /** TableName=AD_Process_Para_Trl */
    public static final String Table_Name="AD_Process_Para_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Process_Para_Trl");
