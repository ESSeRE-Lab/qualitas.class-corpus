...
public class X_AD_UserDef_Tab extends PO
{
    ...
    */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsInsertRecordValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsMultiRowOnlyValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsSingleRowValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
