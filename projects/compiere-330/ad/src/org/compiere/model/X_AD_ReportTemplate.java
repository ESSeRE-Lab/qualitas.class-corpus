...
public class X_AD_ReportTemplate extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_ReportTemplate");
    ...
    public static final int AD_REPORTTEMPLATE_TYPE_AD_Reference_ID=462;
    /** Jasper = 1 */
    ...
    public static boolean isAD_ReportTemplate_TypeValid(String test)
    {
         return X_Ref_AD_ReportTemplate_Type.isValid(test);
    ...
    {
        if (!isAD_ReportTemplate_TypeValid(AD_ReportTemplate_Type))
