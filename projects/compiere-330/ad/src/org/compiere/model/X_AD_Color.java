...
public class X_AD_Color extends PO
{
    ...
    */
    ...
    public static boolean isColorTypeValid(String test)
    {
         return X_Ref_AD_Color_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isStartPointValid(String test)
    {
         return X_Ref_AD_Color_StartPoint.isValid(test);
