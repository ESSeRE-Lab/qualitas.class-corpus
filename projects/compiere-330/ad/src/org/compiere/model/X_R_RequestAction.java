...
public class X_R_RequestAction extends PO
{
    ...
    */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsEscalatedValid(String test)
    {
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsInvoicedValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsSelfServiceValid(String test)
    {
         return X_Ref__YesNo.isValid(test);
