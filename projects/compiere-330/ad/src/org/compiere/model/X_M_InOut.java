...
public class X_M_InOut extends PO
{
    ...
    */
    ...
    public static final int MATCHREQUIREMENTR_AD_Reference_ID=410;
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isMatchRequirementRValid(String test)
    {
         return X_Ref_C_Client_Receipt_MatchRequirement.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isMovementTypeValid(String test)
    {
         return X_Ref_M_Transaction_Movement_Type.isValid(test);
