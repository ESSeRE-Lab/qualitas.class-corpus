...
public class MRecordAccess extends X_AD_Record_Access
{
	 ...
	 */
	public MRecordAccess (Ctx ctx, int ignored, Trx trx)
	{
		super(ctx, 0, trx);
		if (ignored != 0)
	 ...
	 *	@param trx transaction
	 */
	public MRecordAccess (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}	//	MRecordAccess
	 ...
	 *	@param trx transaction
	 */
	public MRecordAccess (Ctx ctx, int AD_Role_ID, int AD_Table_ID, int Record_ID, Trx trx)
	{
		super (ctx,0, trx);
	...
	public String getKeyColumnName (AccessSqlParser.TableInfo[] tableInfo)
	{
		...
		for (TableInfo element : tableInfo) {
