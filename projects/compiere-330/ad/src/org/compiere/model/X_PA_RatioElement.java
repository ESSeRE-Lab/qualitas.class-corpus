...
public class X_PA_RatioElement extends PO
{
    ...
    */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isRatioElementTypeValid(String test)
    {
         return X_Ref_PA_Ratio_ElementType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isRatioOperandValid(String test)
    {
         return X_Ref_PA_Ratio_Operand.isValid(test);
