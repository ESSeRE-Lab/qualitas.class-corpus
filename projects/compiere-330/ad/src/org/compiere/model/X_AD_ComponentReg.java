...
public class X_AD_ComponentReg extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_ComponentReg");
    ...
    public static final int COMPONENTTYPE_AD_Reference_ID=437;
    ...
    public static boolean isComponentTypeValid(String test)
    {
         return X_Ref_AD_ComponentReg_Type.isValid(test);
    ...
    public static final int DISTRIBUTIONTYPE_AD_Reference_ID=438;
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDistributionTypeValid(String test)
    {
         return X_Ref_AD_Component_Distribution.isValid(test);
    ...
    public void setDistributionType (String DistributionType)
    {
        ...
        if (!isDistributionTypeValid(DistributionType))
