...
public class X_AD_LoginMsgLog extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_LoginMsgLog");
    ...
    /** IsUserAccepted AD_Reference_ID=319 */
    public static final int ISUSERACCEPTED_AD_Reference_ID=319;
    /** No = N */
    ...
    public static boolean isIsUserAcceptedValid(String test)
    {
    ...
    {
        if (!isIsUserAcceptedValid(IsUserAccepted))
