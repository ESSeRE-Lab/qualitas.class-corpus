...
public class X_PA_ReportColumn extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27509346869789L;
    /** Last Updated Timestamp 2008-11-20 14:52:33.0 */
    public static final long updatedMS = 1227221553000L;
    /** AD_Table_ID=446 */
    ...
    public static boolean isAmountTypeValid(String test)
    {
         return X_Ref_PA_Report_AmountType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isCalculationTypeValid(String test)
    {
         return X_Ref_PA_Report_CalculationType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isColumnTypeValid(String test)
    {
         return X_Ref_PA_Report_ColumnType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isCurrencyTypeValid(String test)
    {
         return X_Ref_PA_Report_CurrencyType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isElementTypeValid(String test)
    {
         return X_Ref_C_AcctSchema_ElementType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPostingTypeValid(String test)
    {
         return X_Ref__Posting_Type.isValid(test);
