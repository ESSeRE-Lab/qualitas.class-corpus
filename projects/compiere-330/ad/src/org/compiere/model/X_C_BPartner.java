...
public class X_C_BPartner extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27506406174789L;
    /** Last Updated Timestamp 2008-10-17 15:00:58.0 */
    public static final long updatedMS = 1224280858000L;
    /** AD_Table_ID=291 */
    ...
    public static final int AD_ORGBP_ID_AD_Reference_ID=417;
    ...
    public static boolean isDeliveryRuleValid(String test)
    {
         return X_Ref_C_Order_DeliveryRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDeliveryViaRuleValid(String test)
    {
         return X_Ref_C_Order_DeliveryViaRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isFreightCostRuleValid(String test)
    {
         return X_Ref_C_Order_FreightCostRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isInvoiceRuleValid(String test)
    {
         return X_Ref_C_Order_InvoiceRule.isValid(test);
    ...
    public static final int PO_RETURNPOLICY_ID_AD_Reference_ID=431;
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPaymentRulePOValid(String test)
    {
         return X_Ref__Payment_Rule.isValid(test);
    ...
    public static final int RATING_AD_Reference_ID=419;
    /** Not Rated = - */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isRatingValid(String test)
    {
         return X_Ref__Rating__ABC_.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isSOCreditStatusValid(String test)
    {
         return X_Ref_C_BPartner_SOCreditStatus.isValid(test);
