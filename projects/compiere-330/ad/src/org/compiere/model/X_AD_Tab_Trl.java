...
/** Generated Model for AD_Tab_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_AD_Tab_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Tab_Trl_ID id
    @param trx transaction
    */
    public X_AD_Tab_Trl (Ctx ctx, int AD_Tab_Trl_ID, Trx trx)
    {
        super (ctx, AD_Tab_Trl_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Tab_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=123 */
    public static final int Table_ID=123;
    
    /** TableName=AD_Tab_Trl */
    public static final String Table_Name="AD_Tab_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Tab_Trl");
