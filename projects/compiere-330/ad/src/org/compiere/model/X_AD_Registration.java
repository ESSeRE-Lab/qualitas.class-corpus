...
public class X_AD_Registration extends PO
{
    ...
    */
    ...
    public static boolean isEmployeeRangeValid(String test)
    {
         return X_Ref__EmployeeRange.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIndustryValid(String test)
    {
         return X_Ref__IndustryCode.isValid(test);
