...
public class X_C_AllocationHdr extends PO
{
    ...
    */
    public X_C_AllocationHdr (Ctx ctx, int C_AllocationHdr_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_C_AllocationHdr (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27502697733789L;
    /** Last Updated Timestamp 2008-09-04 16:53:37.0 */
    public static final long updatedMS = 1220572417000L;
    /** AD_Table_ID=735 */
