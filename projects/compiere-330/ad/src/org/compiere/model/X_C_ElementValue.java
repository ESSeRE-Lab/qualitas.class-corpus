...
public class X_C_ElementValue extends PO
{
    ...
    */
    ...
    public static boolean isAccountSignValid(String test)
    {
         return X_Ref_C_ElementValue_Account_Sign.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isAccountTypeValid(String test)
    {
         return X_Ref_C_ElementValue_AccountType.isValid(test);
