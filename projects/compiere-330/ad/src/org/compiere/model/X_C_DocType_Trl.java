...
/** Generated Model for C_DocType_Trl
...
public class X_C_DocType_Trl extends PO
{
    ...
    @param ctx context
    @param C_DocType_Trl_ID id
    @param trx transaction
    */
    public X_C_DocType_Trl (Ctx ctx, int C_DocType_Trl_ID, Trx trx)
    {
        super (ctx, C_DocType_Trl_ID, trx);
    ...
    @param trx transaction
    */
    public X_C_DocType_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_DocType_Trl");
