...
public class X_AD_Session extends PO
{
    ...
    */
    ...
    public static final int SESSIONTYPE_AD_Reference_ID=492;
    /** API = A */
    ...
    public static boolean isSessionTypeValid(String test)
    {
         return X_Ref_AD_Session_Type.isValid(test);
    ...
    public void setSessionType (String SessionType)
    {
        ...
        if (!isSessionTypeValid(SessionType))
