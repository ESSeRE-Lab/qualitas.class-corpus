...
public class X_CM_AccessListRole extends PO
{
    ...
    */
    public X_CM_AccessListRole (Ctx ctx, int CM_AccessListRole_ID, Trx trx)
    {
        super (ctx, CM_AccessListRole_ID, trx);
    ...
    @param trx transaction
    */
    public X_CM_AccessListRole (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
