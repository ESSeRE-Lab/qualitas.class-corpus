...
/** Generated Model for AD_Window_Trl
...
public class X_AD_Window_Trl extends PO
{
    ...
    @param ctx context
    @param AD_Window_Trl_ID id
    @param trx transaction
    */
    public X_AD_Window_Trl (Ctx ctx, int AD_Window_Trl_ID, Trx trx)
    {
        super (ctx, AD_Window_Trl_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Window_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Window_Trl");
