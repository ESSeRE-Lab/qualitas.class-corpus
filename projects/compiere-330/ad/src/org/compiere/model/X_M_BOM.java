...
public class X_M_BOM extends PO
{
    ...
    */
    ...
    public static boolean isBOMTypeValid(String test)
    {
         return X_Ref_M_BOM_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isBOMUseValid(String test)
    {
         return X_Ref_M_BOM_Use.isValid(test);
    ...
    public void setBOMUse (String BOMUse)
    {
        ...
        throw new IllegalArgumentException ("BOMUse Invalid value - " + BOMUse + " - Reference_ID=348 - A - E - M - P");
