...
public class X_AD_Role extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27507092199789L;
    /** Last Updated Timestamp 2008-10-25 13:34:43.0 */
    public static final long updatedMS = 1224966883000L;
    /** AD_Table_ID=156 */
    ...
    public static boolean isConnectionProfileValid(String test)
    {
         return X_Ref_AD_User_ConnectionProfile.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDisplayClientOrgValid(String test)
    {
         return X_Ref_AD_Role_DisplayClientOrg.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPreferenceTypeValid(String test)
    {
         return X_Ref_AD_Role_PreferenceType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isUserLevelValid(String test)
    {
         return X_Ref_AD_Role_User_Level.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isWinUserDefLevelValid(String test)
    {
         return X_Ref_AD_Role_WinUserDefLevel.isValid(test);
