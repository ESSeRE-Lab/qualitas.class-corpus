...
public class X_AD_DataMigrationEntry extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_DataMigrationEntry");
    ...
    /** DataMigrationEntryType AD_Reference_ID=440 */
    public static final int DATAMIGRATIONENTRYTYPE_AD_Reference_ID=440;
    /** Record = R */
    ...
    public static boolean isDataMigrationEntryTypeValid(String test)
    {
         return X_Ref_AD_DataMigrationEntry_Type.isValid(test);
    ...
    public void setDataMigrationEntryType (String DataMigrationEntryType)
    {
        ...
        if (!isDataMigrationEntryTypeValid(DataMigrationEntryType))
