...
public class X_K_Category extends PO
{
    ...
    @param ctx context
    @param K_Category_ID id
    @param trx transaction
    */
    public X_K_Category (Ctx ctx, int K_Category_ID, Trx trx)
    {
        super (ctx, K_Category_ID, trx);
    ...
    @param trx transaction
    */
    public X_K_Category (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"K_Category");
