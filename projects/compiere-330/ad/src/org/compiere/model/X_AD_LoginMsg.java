...
public class X_AD_LoginMsg extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_LoginMsg");
    ...
    public static final int LOGINMSGFREQUENCY_AD_Reference_ID=476;
    /** Daily = D */
    ...
    public static boolean isLoginMsgFrequencyValid(String test)
    {
         return X_Ref_AD_LoginMsg_Fequency.isValid(test);
    ...
    public void setLoginMsgFrequency (String LoginMsgFrequency)
    {
        ...
        if (!isLoginMsgFrequencyValid(LoginMsgFrequency))
    ...
    /** LoginMsgType AD_Reference_ID=475 */
    public static final int LOGINMSGTYPE_AD_Reference_ID=475;
    /** Confirmation = C */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isLoginMsgTypeValid(String test)
    {
         return X_Ref_AD_LoginMsg_Type.isValid(test);
    ...
    public void setLoginMsgType (String LoginMsgType)
    {
        ...
        if (!isLoginMsgTypeValid(LoginMsgType))
