...
public class X_M_DiscountSchemaLine extends PO
{
    ...
    */
    ...
    public static boolean isLimit_BaseValid(String test)
    {
         return X_Ref_M_DiscountPriceList_Base.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isLimit_RoundingValid(String test)
    {
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isList_BaseValid(String test)
    {
         return X_Ref_M_DiscountPriceList_Base.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isList_RoundingValid(String test)
    {
         return X_Ref_M_DiscountPriceList_RoundingRule.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isStd_BaseValid(String test)
    {
         return X_Ref_M_DiscountPriceList_Base.isValid(test);
