...
public class X_M_CostUpdateLine extends PO
{
    /** Standard Constructor
    @param ctx context
    @param M_CostUpdateLine_ID id
    @param trx transaction
    */
    public X_M_CostUpdateLine (Ctx ctx, int M_CostUpdateLine_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_M_CostUpdateLine (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=1037 */
    public static final int Table_ID=1037;
    
    /** TableName=M_CostUpdateLine */
    public static final String Table_Name="M_CostUpdateLine";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"M_CostUpdateLine");
    ...
    {
        if (M_CostUpdateLine_ID < 1) throw new IllegalArgumentException ("M_CostUpdateLine_ID is mandatory.");
        set_ValueNoCheck ("M_CostUpdateLine_ID", Integer.valueOf(M_CostUpdateLine_ID));
    ...
    {
        return get_ValueAsInt("M_CostUpdateLine_ID");
