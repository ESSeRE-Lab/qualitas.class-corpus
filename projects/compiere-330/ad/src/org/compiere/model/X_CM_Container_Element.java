...
public class X_CM_Container_Element extends PO
{
    ...
    */
    public X_CM_Container_Element (Ctx ctx, int CM_Container_Element_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_CM_Container_Element (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"CM_Container_Element");
