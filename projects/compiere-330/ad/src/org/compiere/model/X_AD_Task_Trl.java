...
/** Generated Model for AD_Task_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_AD_Task_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Task_Trl_ID id
    @param trx transaction
    */
    public X_AD_Task_Trl (Ctx ctx, int AD_Task_Trl_ID, Trx trx)
    {
        super (ctx, AD_Task_Trl_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Task_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** TableName=AD_Task_Trl */
    public static final String Table_Name="AD_Task_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Task_Trl");
