...
public class X_C_Lead extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_Lead");
    ...
    public static final int LEADRATING_AD_Reference_ID=421;
    /** Hot = 1 */
    ...
    public static boolean isLeadRatingValid(String test)
    {
         return X_Ref_C_Lead_Rating.isValid(test);
