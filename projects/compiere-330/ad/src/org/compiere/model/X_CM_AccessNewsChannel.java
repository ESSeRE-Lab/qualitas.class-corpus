...
public class X_CM_AccessNewsChannel extends PO
{
    ...
    @param ctx context
    @param CM_AccessNewsChannel_ID id
    @param trx transaction
    */
    public X_CM_AccessNewsChannel (Ctx ctx, int CM_AccessNewsChannel_ID, Trx trx)
    {
        super (ctx, CM_AccessNewsChannel_ID, trx);
    ...
    @param trx transaction
    */
    public X_CM_AccessNewsChannel (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
