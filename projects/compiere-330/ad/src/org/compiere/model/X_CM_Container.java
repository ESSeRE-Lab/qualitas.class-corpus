...
public class X_CM_Container extends PO
{
    ...
    */
    public X_CM_Container (Ctx ctx, int CM_Container_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_CM_Container (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27509346260789L;
    /** Last Updated Timestamp 2008-11-20 14:42:24.0 */
    public static final long updatedMS = 1227220944000L;
    /** AD_Table_ID=855 */
    ...
    {
        return get_ValueAsInt("CM_ContainerLink_ID");
    ...
    public static boolean isContainerTypeValid(String test)
    {
         return X_Ref_CM_Container_Type.isValid(test);
