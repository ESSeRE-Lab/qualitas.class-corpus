...
public class X_M_WorkOrder extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27498790429789L;
    /** Last Updated Timestamp 2008-07-21 11:31:53.0 */
    public static final long updatedMS = 1216665113000L;
    /** AD_Table_ID=1026 */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"M_WorkOrder");
    ...
    public static final int WOSOURCE_AD_Reference_ID=449;
    /** Sales Order = O */
    public static final String WOSOURCE_SalesOrder = X_Ref_M_WorkOrder_WOSource.SALES_ORDER.getValue();
    /** Is test a valid value.
    @param test testvalue
    @return true if valid **/
    public static boolean isWOSourceValid(String test)
    {
         return X_Ref_M_WorkOrder_WOSource.isValid(test);
