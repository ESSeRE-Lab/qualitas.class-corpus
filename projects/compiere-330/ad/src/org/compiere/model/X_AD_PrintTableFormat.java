...
public class X_AD_PrintTableFormat extends PO
{
    ...
    */
    ...
    public static boolean isHdrStrokeTypeValid(String test)
    {
         return X_Ref_AD_PrintTableFormat_Stroke.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isLineStrokeTypeValid(String test)
    {
         return X_Ref_AD_PrintTableFormat_Stroke.isValid(test);
