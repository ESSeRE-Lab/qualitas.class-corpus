...
public class X_C_CashLine extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27502698162789L;
    /** Last Updated Timestamp 2008-09-04 17:00:46.0 */
    public static final long updatedMS = 1220572846000L;
    /** AD_Table_ID=410 */
    ...
    /** General Expense = E */
    public static final String CASHTYPE_GeneralExpense = X_Ref_C_Cash_Trx_Type.GENERAL_EXPENSE.getValue();
    /** Invoice = I */
    public static final String CASHTYPE_Invoice = X_Ref_C_Cash_Trx_Type.INVOICE.getValue();
    /** General Receipts = R */
    public static final String CASHTYPE_GeneralReceipts = X_Ref_C_Cash_Trx_Type.GENERAL_RECEIPTS.getValue();
    ...
    public static boolean isCashTypeValid(String test)
    {
         return X_Ref_C_Cash_Trx_Type.isValid(test);
