...
public class X_AD_Version extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_Version_ID id
    @param trx transaction
    */
    public X_AD_Version (Ctx ctx, int AD_Version_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_AD_Version (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=921 */
    public static final int Table_ID=921;
    
    /** TableName=AD_Version */
    public static final String Table_Name="AD_Version";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_Version");
