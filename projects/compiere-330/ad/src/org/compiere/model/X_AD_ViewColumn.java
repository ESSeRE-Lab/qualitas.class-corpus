...
public class X_AD_ViewColumn extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_ViewColumn");
    ...
    public static final int DBDATATYPE_AD_Reference_ID=422;
    /** Binary LOB = B */
    ...
    public static boolean isDBDataTypeValid(String test)
    {
         return X_Ref_AD_Element_Data_Type.isValid(test);
