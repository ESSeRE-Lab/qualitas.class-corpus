...
public class X_AD_BView_Source extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_BView_Source");
    ...
    public static final int SOURCETYPE_AD_Reference_ID=457;
    /** Table or View = 1 */
    ...
    public static boolean isSourceTypeValid(String test)
    {
         return X_Ref_AD_BView_SourceType.isValid(test);
