...
public class X_C_WaveSortCriteriaLine extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_WaveSortCriteriaLine");
    ...
    /** OrderByType AD_Reference_ID=473 */
    public static final int ORDERBYTYPE_AD_Reference_ID=473;
    /** Ascending = A */
    ...
    public static boolean isOrderByTypeValid(String test)
    {
         return X_Ref_Order_By_Type.isValid(test);
    ...
    public void setOrderByType (String OrderByType)
    {
        ...
        if (!isOrderByTypeValid(OrderByType))
