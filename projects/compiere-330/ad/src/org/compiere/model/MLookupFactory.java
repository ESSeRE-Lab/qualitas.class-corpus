...
{
	/**	Logging								*/
	private static final CLogger		s_log = CLogger.getCLogger(MLookupFactory.class);
	...
	//	int AD_Table_ID = 0;
		...
		try
		{
			PreparedStatement pstmt = DB.prepareStatement(sql0, (Trx) null);
	...
	{
		String TableName = ColumnName.endsWith("_ID") ? ColumnName.substring(0,ColumnName.length()-3) : ColumnName;
