...
public class X_M_MatchPO extends PO
{
    ...
    */
    public X_M_MatchPO (Ctx ctx, int M_MatchPO_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_M_MatchPO (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27502698024789L;
    /** Last Updated Timestamp 2008-09-04 16:58:28.0 */
    public static final long updatedMS = 1220572708000L;
    /** AD_Table_ID=473 */
    ...
    {
        return get_ValueAsBigDecimal("PriceMatchDifference");
