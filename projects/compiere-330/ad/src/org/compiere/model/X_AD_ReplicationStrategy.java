...
public class X_AD_ReplicationStrategy extends PO
{
    ...
    */
    public X_AD_ReplicationStrategy (Ctx ctx, int AD_ReplicationStrategy_ID, Trx trx)
    {
        super (ctx, AD_ReplicationStrategy_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_ReplicationStrategy (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
