...
public class X_C_InvoiceSchedule extends PO
{
    ...
    */
    ...
    public static boolean isInvoiceFrequencyValid(String test)
    {
         return X_Ref_C_InvoiceSchedule_InvoiceFrequency.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isInvoiceWeekDayValid(String test)
    {
         return X_Ref_Weekdays.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isInvoiceWeekDayCutoffValid(String test)
    {
         return X_Ref_Weekdays.isValid(test);
