...
public class X_AD_RecentItem extends PO
{
    ...
    */
    public X_AD_RecentItem (Ctx ctx, int AD_RecentItem_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_AD_RecentItem (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27500630569789L;
    /** Last Updated Timestamp 2008-08-11 18:40:53.0 */
    public static final long updatedMS = 1218505253000L;
    /** AD_Table_ID=983 */
    public static final int Table_ID=983;
    
    /** TableName=AD_RecentItem */
    public static final String Table_Name="AD_RecentItem";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_RecentItem");
