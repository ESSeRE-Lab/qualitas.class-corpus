...
/** Generated Model for CM_Container_Element_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_CM_Container_Element_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param CM_Container_Element_Trl_ID id
    @param trx transaction
    */
    public X_CM_Container_Element_Trl (Ctx ctx, int CM_Container_Element_Trl_ID, Trx trx)
    {
        super (ctx, CM_Container_Element_Trl_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (CM_Container_Element_Trl_ID == 0)
        {
            setAD_Language (null);
    ...
    @param trx transaction
    */
    public X_CM_Container_Element_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=861 */
    public static final int Table_ID=861;
    
    /** TableName=CM_Container_Element_Trl */
    public static final String Table_Name="CM_Container_Element_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"CM_Container_Element_Trl");
    ...
    public void setCM_Container_Element_ID (int CM_Container_Element_ID)
    {
        ...
        set_ValueNoCheck ("CM_Container_Element_ID", Integer.valueOf(CM_Container_Element_ID));
    ...
    {
        return get_ValueAsInt("CM_Container_Element_ID");
