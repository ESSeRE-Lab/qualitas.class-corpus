...
public class X_AD_Role_OrgAccess extends PO
{
    ...
    */
    public X_AD_Role_OrgAccess (Ctx ctx, int AD_Role_OrgAccess_ID, Trx trx)
    {
        super (ctx, AD_Role_OrgAccess_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Role_OrgAccess (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27509167301789L;
    /** Last Updated Timestamp 2008-11-18 12:59:45.0 */
    public static final long updatedMS = 1227041985000L;
    /** AD_Table_ID=422 */
