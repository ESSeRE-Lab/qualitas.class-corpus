...
/** Generated Model for AD_ComponentUse
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_AD_ComponentUse extends PO
{
    ...
    */
    public X_AD_ComponentUse (Ctx ctx, int AD_ComponentUse_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_AD_ComponentUse (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=1005 */
    public static final int Table_ID=1005;
    
    /** TableName=AD_ComponentUse */
    public static final String Table_Name="AD_ComponentUse";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_ComponentUse");
    ...
    /** Set Component Use.
    @param AD_ComponentUse_ID Log of the use of Components */
    public void setAD_ComponentUse_ID (int AD_ComponentUse_ID)
    {
        if (AD_ComponentUse_ID < 1) throw new IllegalArgumentException ("AD_ComponentUse_ID is mandatory.");
        set_ValueNoCheck ("AD_ComponentUse_ID", Integer.valueOf(AD_ComponentUse_ID));
        
    }
    
    /** Get Component Use.
    @return Log of the use of Components */
    public int getAD_ComponentUse_ID() 
    {
        return get_ValueAsInt("AD_ComponentUse_ID");
