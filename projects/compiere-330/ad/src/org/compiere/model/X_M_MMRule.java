...
public class X_M_MMRule extends PO
{
    ...
    */
    ...
    public static boolean isMMTypeValid(String test)
    {
         return X_Ref_TaskType.isValid(test);
    ...
    /** Use custom class = MMG */
    public static final String RULE_UseCustomClass = X_Ref_Material_Management_Rule.USE_CUSTOM_CLASS.getValue();
    /** Is test a valid value.
    @param test testvalue
    @return true if valid **/
    public static boolean isRuleValid(String test)
    {
         return X_Ref_Material_Management_Rule.isValid(test);
    ...
    public void setRule (String Rule)
    {
        ...
        if (!isRuleValid(Rule))
        throw new IllegalArgumentException ("Rule Invalid value - " + Rule + " - Reference_ID=456 - MMA - MMB - MMC - MMD - MME - MMF - MMG");
        set_Value ("Rule", Rule);
