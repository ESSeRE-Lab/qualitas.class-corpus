...
public class X_AD_Column extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27510977464789L;
    /** Last Updated Timestamp 2008-12-09 11:49:08.0 */
    public static final long updatedMS = 1228852148000L;
    /** AD_Table_ID=101 */
    ...
    public static boolean isConstraintTypeValid(String test)
    {
         return X_Ref_AD_Column_ConstraintType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isIsEncryptedValid(String test)
    {
         return X_Ref_AD_Column_Encrypted.isValid(test);
