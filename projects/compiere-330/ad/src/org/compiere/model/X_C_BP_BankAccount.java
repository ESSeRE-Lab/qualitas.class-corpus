...
public class X_C_BP_BankAccount extends PO
{
    ...
    */
    ...
    public static boolean isBPBankAcctUseValid(String test)
    {
         return X_Ref_C_BPartner_BPBankAcctUse.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isBankAccountTypeValid(String test)
    {
         return X_Ref_C_Bank_Account_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isCreditCardTypeValid(String test)
    {
         return X_Ref_C_Payment_CreditCard_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isR_AvsAddrValid(String test)
    {
         return X_Ref_C_Payment_AVS.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isR_AvsZipValid(String test)
    {
         return X_Ref_C_Payment_AVS.isValid(test);
