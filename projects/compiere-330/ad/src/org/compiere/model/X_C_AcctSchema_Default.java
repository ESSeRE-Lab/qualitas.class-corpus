...
public class X_C_AcctSchema_Default extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27496740116789L;
    /** Last Updated Timestamp 2008-06-27 18:00:00.0 */
    public static final long updatedMS = 1214614800000L;
    /** AD_Table_ID=315 */
    ...
    /** Set Work Order Resource Overhead Variance.
    @param WO_ResourceOverhdVariance_Acct Work Order Resource Overhead Variance Account */
    public void setWO_ResourceOverhdVariance_Acct (int WO_ResourceOverhdVariance_Acct)
    {
        set_Value ("WO_ResourceOverhdVariance_Acct", Integer.valueOf(WO_ResourceOverhdVariance_Acct));
        
    }
    
    /** Get Work Order Resource Overhead Variance.
    @return Work Order Resource Overhead Variance Account */
    public int getWO_ResourceOverhdVariance_Acct() 
    {
        return get_ValueAsInt("WO_ResourceOverhdVariance_Acct");
        
    }
    
    /** Set Work Order Resource Overhead.
    @param WO_ResourceOverhd_Acct Work Order Resource Overhead Account */
    public void setWO_ResourceOverhd_Acct (int WO_ResourceOverhd_Acct)
    {
        set_Value ("WO_ResourceOverhd_Acct", Integer.valueOf(WO_ResourceOverhd_Acct));
        
    }
    
    /** Get Work Order Resource Overhead.
    @return Work Order Resource Overhead Account */
    public int getWO_ResourceOverhd_Acct() 
    {
        return get_ValueAsInt("WO_ResourceOverhd_Acct");
