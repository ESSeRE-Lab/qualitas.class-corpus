...
/** Generated Model for CM_CStage_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_CM_CStage_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param CM_CStage_Trl_ID id
    @param trx transaction
    */
    public X_CM_CStage_Trl (Ctx ctx, int CM_CStage_Trl_ID, Trx trx)
    {
        super (ctx, CM_CStage_Trl_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (CM_CStage_Trl_ID == 0)
        {
            setAD_Language (null);
            setCM_CStage_ID (0);
    ...
    @param trx transaction
    */
    public X_CM_CStage_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=869 */
    public static final int Table_ID=869;
    
    /** TableName=CM_CStage_Trl */
    public static final String Table_Name="CM_CStage_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"CM_CStage_Trl");
