...
public class X_M_FreightCategory extends PO
{
    ...
    */
    public X_M_FreightCategory (Ctx ctx, int M_FreightCategory_ID, Trx trx)
    {
        super (ctx, M_FreightCategory_ID, trx);
    ...
    @param trx transaction
    */
    public X_M_FreightCategory (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
