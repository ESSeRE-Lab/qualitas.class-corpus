...
public class X_AD_Private_Access extends PO
{
    ...
    */
    public X_AD_Private_Access (Ctx ctx, int AD_Private_Access_ID, Trx trx)
    {
        super (ctx, AD_Private_Access_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_Private_Access (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
