...
public class X_CM_Template_Ad_Cat extends PO
{
    ...
    @param ctx context
    @param CM_Template_Ad_Cat_ID id
    @param trx transaction
    */
    public X_CM_Template_Ad_Cat (Ctx ctx, int CM_Template_Ad_Cat_ID, Trx trx)
    {
        super (ctx, CM_Template_Ad_Cat_ID, trx);
    ...
    @param trx transaction
    */
    public X_CM_Template_Ad_Cat (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"CM_Template_Ad_Cat");
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getCM_Template_ID()));
