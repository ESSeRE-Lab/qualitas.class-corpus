...
public class X_R_RequestProcessor_Route extends PO
{
    ...
    */
    public X_R_RequestProcessor_Route (Ctx ctx, int R_RequestProcessor_Route_ID, Trx trx)
    {
        super (ctx, R_RequestProcessor_Route_ID, trx);
    ...
    @param trx transaction
    */
    public X_R_RequestProcessor_Route (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    {
        return get_ValueAsInt("R_RequestProcessor_Route_ID");
