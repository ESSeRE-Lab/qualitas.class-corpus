...
public class X_C_BP_Size extends PO
{
    ...
    */
    public X_C_BP_Size (Ctx ctx, int C_BP_Size_ID, Trx trx)
    {
        super (ctx, C_BP_Size_ID, trx);
    ...
    @param trx transaction
    */
    public X_C_BP_Size (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_BP_Size");
    ...
    public void setC_BP_Size_ID (int C_BP_Size_ID)
    {
        ...
        set_ValueNoCheck ("C_BP_Size_ID", Integer.valueOf(C_BP_Size_ID));
