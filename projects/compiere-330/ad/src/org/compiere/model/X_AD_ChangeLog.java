...
public class X_AD_ChangeLog extends PO
{
    ...
    */
    ...
    public static final int CHANGELOGTYPE_AD_Reference_ID=430;
    /** Delete = D */
    ...
    public static boolean isChangeLogTypeValid(String test)
    {
         return X_Ref_AD_ChangeLog_Type.isValid(test);
