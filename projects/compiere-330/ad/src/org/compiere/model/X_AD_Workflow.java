...
public class X_AD_Workflow extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27503984831789L;
    /** Last Updated Timestamp 2008-09-19 14:25:15.0 */
    public static final long updatedMS = 1221859515000L;
    /** AD_Table_ID=117 */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isDurationUnitValid(String test)
    {
         return X_Ref_WF_DurationUnit.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPublishStatusValid(String test)
    {
         return X_Ref__PublishStatus.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isWorkflowTypeValid(String test)
    {
         return X_Ref_AD_Workflow_Type.isValid(test);
