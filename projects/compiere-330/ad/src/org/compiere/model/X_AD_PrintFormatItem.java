...
public class X_AD_PrintFormatItem extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27513433273789L;
    /** Last Updated Timestamp 2009-01-06 21:59:17.0 */
    public static final long updatedMS = 1231307957000L;
    /** AD_Table_ID=489 */
    ...
    public static boolean isBarcodeTypeValid(String test)
    {
         return X_Ref_AD_PrintFormatItem_BarcodeType.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isFieldAlignmentTypeValid(String test)
    {
         return X_Ref_AD_Print_Field_Alignment.isValid(test);
    ...
    /** Set Ascending Order.
    @param IsAscending Include in sort order */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isLineAlignmentTypeValid(String test)
    {
         return X_Ref_AD_Print_Line_Alignment.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPrintAreaTypeValid(String test)
    {
         return X_Ref_AD_Print_Area.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isPrintFormatTypeValid(String test)
    {
         return X_Ref_AD_Print_Format_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isShapeTypeValid(String test)
    {
         return X_Ref_AD_PrintFormatItem_ShapeType.isValid(test);
