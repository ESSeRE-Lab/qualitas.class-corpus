...
public class X_AD_BView extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_BView");
    ...
    /** AD_BView_Type AD_Reference_ID=459 */
    public static final int AD_BVIEW_TYPE_AD_Reference_ID=459;
    /** Financial = 1 */
    ...
    public static boolean isAD_BView_TypeValid(String test)
    {
         return X_Ref_AD_BView_Type.isValid(test);
    ...
    {
        if (!isAD_BView_TypeValid(AD_BView_Type))
