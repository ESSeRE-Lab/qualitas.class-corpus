...
public class X_AD_DataMigration extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_DataMigration");
    ...
    public static final int AD_CLIENTINCLUDE_ID_AD_Reference_ID=129;
    /** Set Include Tenant.
    ...
    public static final int DATAMIGRATIONTYPE_AD_Reference_ID=439;
    /** System and Tenant = A */
    ...
    public static boolean isDataMigrationTypeValid(String test)
    {
         return X_Ref_AD_DataMigration_Type.isValid(test);
    ...
    public void setDataMigrationType (String DataMigrationType)
    {
        ...
        if (!isDataMigrationTypeValid(DataMigrationType))
