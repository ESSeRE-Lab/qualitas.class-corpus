...
public class X_AD_PrintColor extends PO
{
    ...
    */
    public X_AD_PrintColor (Ctx ctx, int AD_PrintColor_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_AD_PrintColor (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    public void setAD_PrintColor_ID (int AD_PrintColor_ID)
    {
        ...
        set_ValueNoCheck ("AD_PrintColor_ID", Integer.valueOf(AD_PrintColor_ID));
