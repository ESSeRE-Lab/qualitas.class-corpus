...
public class X_AD_TreeNodeCMC extends PO
{
    ...
    @param ctx context
    @param AD_TreeNodeCMC_ID id
    @param trx transaction
    */
    public X_AD_TreeNodeCMC (Ctx ctx, int AD_TreeNodeCMC_ID, Trx trx)
    {
        super (ctx, AD_TreeNodeCMC_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_TreeNodeCMC (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
