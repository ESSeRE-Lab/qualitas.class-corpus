...
public class X_C_Invoice extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27510377737789L;
    /** Last Updated Timestamp 2008-12-02 13:13:41.0 */
    public static final long updatedMS = 1228252421000L;
    /** AD_Table_ID=318 */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isInvoiceCollectionTypeValid(String test)
    {
         return X_Ref_C_Invoice_InvoiceCollectionType.isValid(test);
    ...
    public static final int MATCHREQUIREMENTI_AD_Reference_ID=360;
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isMatchRequirementIValid(String test)
    {
         return X_Ref_C_Client_Invoice_MatchRequirement.isValid(test);
