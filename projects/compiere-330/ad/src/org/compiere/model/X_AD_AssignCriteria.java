...
public class X_AD_AssignCriteria extends PO
{
    ...
    */
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_AssignCriteria");
    ...
    public static final int AD_SOURCECOLUMN_ID_AD_Reference_ID=414;
    /** Set Source Column.
    ...
    public static boolean isAndOrValid(String test)
    {
         return X_Ref__AndOr.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isOperationValid(String test)
    {
         return X_Ref_AD_Find_Operation.isValid(test);
