...
/** Generated Model for C_Country_Trl
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_C_Country_Trl extends PO
{
    /** Standard Constructor
    @param ctx context
    @param C_Country_Trl_ID id
    @param trx transaction
    */
    public X_C_Country_Trl (Ctx ctx, int C_Country_Trl_ID, Trx trx)
    {
        super (ctx, C_Country_Trl_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (C_Country_Trl_ID == 0)
        {
            setAD_Language (null);
            setC_Country_ID (0);
    ...
    @param trx transaction
    */
    public X_C_Country_Trl (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=616 */
    public static final int Table_ID=616;
    
    /** TableName=C_Country_Trl */
    public static final String Table_Name="C_Country_Trl";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_Country_Trl");
