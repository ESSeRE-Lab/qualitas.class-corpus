...
public class X_AD_TreeNodeCMS extends PO
{
    ...
    */
    public X_AD_TreeNodeCMS (Ctx ctx, int AD_TreeNodeCMS_ID, Trx trx)
    {
        super (ctx, AD_TreeNodeCMS_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_TreeNodeCMS (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_TreeNodeCMS");
