...
public class X_AD_TreeNodeU1 extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AD_TreeNodeU1_ID id
    @param trx transaction
    */
    public X_AD_TreeNodeU1 (Ctx ctx, int AD_TreeNodeU1_ID, Trx trx)
    {
        super (ctx, AD_TreeNodeU1_ID, trx);
    ...
    @param trx transaction
    */
    public X_AD_TreeNodeU1 (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AD_TreeNodeU1");
