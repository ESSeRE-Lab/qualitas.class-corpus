...
public class X_C_Payment extends PO
{
    ...
    */
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTenderTypeValid(String test)
    {
         return X_Ref_C_Payment_Tender_Type.isValid(test);
    ...
    @param test testvalue
    @return true if valid **/
    public static boolean isTrxTypeValid(String test)
    {
         return X_Ref_C_Payment_Trx_Type.isValid(test);
