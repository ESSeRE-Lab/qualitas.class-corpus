...
/** Generated Model for C_UOMGroup
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.2_Dev - $Id$ */
public class X_C_UOMGroup extends PO
{
    ...
    */
    public X_C_UOMGroup (Ctx ctx, int C_UOMGroup_ID, Trx trx)
    {
    ...
    @param trx transaction
    */
    public X_C_UOMGroup (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    static
    {
        Table_ID = get_Table_ID("C_UOMGroup");
        
    }
    ;
    
    /** TableName=C_UOMGroup */
    public static final String Table_Name="C_UOMGroup";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_UOMGroup");
