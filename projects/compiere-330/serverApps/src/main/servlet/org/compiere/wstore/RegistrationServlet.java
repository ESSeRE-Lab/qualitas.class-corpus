...
public class RegistrationServlet extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		String company = WebUtil.getParameter (request, "Company");
		if (name==null||name.length()<1||name.equals("?")) name = company;
		...
		WebUtil.getParameterAsBoolean (request, "IsRegistered", "Y");
		...
		//	Common Update
		if (description!=null && description.length()>0) reg.setDescription(description);
