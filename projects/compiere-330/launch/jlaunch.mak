...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Compiere2.pdb" /machine:I386 /out:"$(OUTDIR)\Compiere2.exe" 
LINK32_OBJS= \
	"$(INTDIR)\jlaunch.obj" \
	"$(INTDIR)\StdAfx.obj" \
	"$(INTDIR)\jlaunch.res"

"$(OUTDIR)\Compiere2.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
