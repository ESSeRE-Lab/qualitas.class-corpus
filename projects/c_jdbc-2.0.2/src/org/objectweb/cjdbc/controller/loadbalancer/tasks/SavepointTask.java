...
public class SavepointTask extends AbstractTask
{
   ...
   * @param savepointName a name for the savepoint 
   */
  public SavepointTask(int nbToComplete, int totalNb, long timeout, String login,
      long transactionId, String savepointName)
  {
      ...
      throws SQLException
  {
    ...
    { // Bad connection
      ...
      // thread
      backendThread.kill();
      String msg = "Failed to set savepoint for transaction " + transactionId
  ...
  {
    return "SavepointTask for transaction " + transactionId + " ("
        + savepointName + ")";
  }
}
