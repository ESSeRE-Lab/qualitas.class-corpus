 ...
 * @version 1.0
 */
public class WriteRequestWithKeysTask extends AbstractTask
{
   ...
   */
  public WriteRequestWithKeysTask(int nbToComplete, int totalNb,
      ...
      throws SQLException
  {
    ...
    if (request.isAutoCommit())
    {
      ...
      {
        // Backend is disabling, we do not start new transactions, just notify
      ...
      try
      {
        result = AbstractLoadBalancer.executeUpdateRequestOnBackendWithKeys(
            request, backend, c, metadataCache);
  ...
  {
    if (request.isAutoCommit())
      return "WriteWithKeys  Autocommit Task (" + request.getSQL() + ")";
    else
