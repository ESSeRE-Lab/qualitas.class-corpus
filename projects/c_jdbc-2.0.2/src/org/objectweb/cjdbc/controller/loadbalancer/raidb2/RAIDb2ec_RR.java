 ...
 * @version 1.0
 */
public class RAIDb2ec_RR extends RAIDb2ec
{
  /*
  ...
  {
    if (backends == null)
      return "RAIDb-2 Error Checking with Round Robin Request load balancer: !!!Warning!!! No backend nodes found\n";
    else
      return "RAIDb-2 Error Checking with Round Robin Request load balancer balancing over "
          + backends.size() + " nodes\n";
  }
  ...
  {
    return "<" + DatabasesXmlTags.ELT_RAIDb_2ec_RoundRobin + "/>";
  }
}