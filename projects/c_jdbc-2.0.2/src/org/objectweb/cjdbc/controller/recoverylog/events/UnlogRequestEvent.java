 ...
 * @version 1.0
 */
public class UnlogRequestEvent implements LogEvent
{
  private LogEntry logEntry;

  /**
   * Creates a new <code>UnlogRequestEvent</code> object
   * 
  ...
  public void execute(LoggerThread loggerThread)
  {
    ...
    try
    {
      if (logger.isInfoEnabled())
        logger.info(Translate.get("recovery.jdbc.loggerthread.unlog.info",
            logEntry.getId()));

      PreparedStatement pstmt = loggerThread.getUnlogPreparedStatement();
