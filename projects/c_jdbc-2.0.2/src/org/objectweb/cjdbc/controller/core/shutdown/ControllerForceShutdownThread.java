 ...
 * @version 1.0
 */
public class ControllerForceShutdownThread extends ControllerShutdownThread
{
  ...
  {
    super(controller, Constants.SHUTDOWN_FORCE);
  }
  ...
  public void shutdown() throws ShutdownException
  {
    ...
    shutdownJmxAgent();
    // Wait for a maximum of 5 seconds for thread termination.
    shutdownServerConnectionThread(5000);
