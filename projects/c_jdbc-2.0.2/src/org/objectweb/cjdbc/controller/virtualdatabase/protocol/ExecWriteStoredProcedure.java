 ...
 * @version 1.0
 */
public class ExecWriteStoredProcedure extends DistributedRequest
{
   ...
   */
  public ExecWriteStoredProcedure(StoredProcedure proc)
  {
    super(proc);
  }
  ...
  public Object executeScheduledRequest(DistributedRequestManager drm)
      throws SQLException
  {
    int execWriteStoredProcedure = 0;
    ...
    try
    {
      ...
      execWriteStoredProcedure = drm.loadBalanceWriteStoredProcedure(proc);

      drm.flushCacheAndLogStoredProcedure(proc, false);

      // Notify scheduler of completion
      drm.getScheduler().storedProcedureCompleted(proc);

      return new Integer(execWriteStoredProcedure);
    }
