...
/**
 * This class defines an UnlogRollback command that is sent when a rollback has
 * failed on all controllers and it is necessary for controllers without backend
 * to remove this rollback from their recovery log since they systematically log
 ...
 * @version 1.0
 */
public class UnlogRollback extends DistributedRequest
{
  private static final long         serialVersionUID = 2047719483769682759L;

  private TransactionMarkerMetaData tm;

  /**
   * Creates a new <code>UnlogRollback</code> object
   * 
   * @param tm the identifier of the rollbacked transaction to unlog from the
  ...
  public final Object executeScheduledRequest(DistributedRequestManager drm)
      throws SQLException
  {
    drm.removeFailedRollbackFromRecoveryLog(tm);
    return null;
  }
