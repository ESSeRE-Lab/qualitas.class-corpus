...
{
  /**
   * Creates a new <code>Connect.java</code> object
   * 
   * @param module the command is attached to
   */
  public Connect(AbstractConsoleModule module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws Exception
  {
    if (commandText == null)
      commandText = "";
    console.getConsoleModule().login(new String[]{commandText.trim()});
    console.getConsoleModule().handlePrompt();
  }
  ...
  {
    return ConsoleTranslate.get("controller.command.connect.params");
  }
  ...
  {
    return ConsoleTranslate.get("controller.command.connect.description");
  }
