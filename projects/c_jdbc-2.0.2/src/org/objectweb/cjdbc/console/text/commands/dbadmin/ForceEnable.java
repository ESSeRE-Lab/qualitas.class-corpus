...
public class ForceEnable extends AbstractAdminCommand
{
  ...
  public void parse(String commandText) throws Exception
  {
    ...
    for (int i = 0; i < backendNames.length; i++)
    {
      ...
      console.println(ConsoleTranslate.get(
          "admin.command.force.enable.backend", backendName));
  ...
  {
    return ConsoleTranslate.get("admin.command.force.enable.description");
  }
  ...
  {
    return ConsoleTranslate.get("admin.command.force.enable.params");
  }
}
