 ...
 */
public class Begin extends ConsoleCommand
{

  /**
   * Creates a new <code>Begin</code> object
   * 
   * @param module the command is attached to
   */
  public Begin(VirtualDatabaseConsole module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws IOException, ConsoleException
  {
    ...
    try
    {
      ...
      console.println(ConsoleTranslate.get("sql.display.transaction.started"));
    }
    catch (Exception e)
    {
  ...
  {
    return ConsoleTranslate.get("sql.command.begin");
  }
}