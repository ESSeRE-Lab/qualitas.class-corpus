 ...
 * @version 1.0
 */
public class ShowRecoveryLog extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowRecoveryLog</code> object
   * 
   * @param module the owning module
   */
  public ShowRecoveryLog(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy().retrieveRecoveryLogData(
        currentTarget), new RecoveryLogViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.recovery");
  }
