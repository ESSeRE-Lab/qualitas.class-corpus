 ...
 * @version 1.0
 */
public class ShowStats extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowStats.java</code> object
   * 
   * @param module monitoring module
   */
  public ShowStats(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy().retrieveSQLStats(
        currentTarget), new SQLStatViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.stats");
  }
