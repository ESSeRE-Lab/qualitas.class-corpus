 ...
 * @version 1.0
 */
public class SaveConfiguration extends ConsoleCommand
{

  /**
   * Creates a new <code>SaveConfiguration.java</code> object
   * 
   * @param module the command is attached to
   */
  public SaveConfiguration(AbstractConsoleModule module)
  {
    super(module);
  }
  ...
  {
    String msg = jmxClient.getControllerProxy().saveConfiguration();
  ...
  {
    return ConsoleTranslate.get("controller.command.saveConfiguration");
  }
