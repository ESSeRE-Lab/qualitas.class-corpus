 ...
 * @version 1.0
 */
public class ShowBackends extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowBackends.java</code> object
   * 
   * @param module monitoring module
   */
  public ShowBackends(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy().retrieveBackendsData(
        currentTarget), new BackendViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.backends");
  }
