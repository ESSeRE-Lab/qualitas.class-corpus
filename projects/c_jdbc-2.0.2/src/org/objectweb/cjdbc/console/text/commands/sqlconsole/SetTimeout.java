...
public class SetTimeout extends ConsoleCommand
{
  ...
  public void parse(String commandText) throws IOException, ConsoleException
  {
    try
    {
      ...
      console.println(ConsoleTranslate.get("sql.command.timeout.value",
          timeout));
    }
  ...
  {
    return ConsoleTranslate.get("sql.command.timeout.params");
  }
  ...
  {
    return ConsoleTranslate.get("sql.command.timeout.description");
  }
}