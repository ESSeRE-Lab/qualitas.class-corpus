 ...
 * @version 1.0
 */
public class ShowController extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowController.java</code> object
   * 
   * @param module monitoring module
   */
  public ShowController(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy()
        .retrieveControllerLoadData(), new ControllerLoadViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.controller");
  }
