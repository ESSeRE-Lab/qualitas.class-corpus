 ...
 * @version 1.0
 */
public class ShowDatabases extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowDatabases.java</code> object
   * 
   * @param module monitoring module
   */
  public ShowDatabases(MonitorConsole module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws Exception
  {
    console.showInfo(jmxClient.getDataCollectorProxy()
        .retrieveVirtualDatabasesData(), new DatabasesViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.databases");
  }
