 ...
 * @version 1.0
 */
public class Native extends ConsoleCommand
{

  /**
   * Creates a new <code>Native.java</code> object
   * 
   * @param module the command is issued from
   */
  public Native(AbstractConsoleModule module)
  {
    super(module);
  }
  ...
  {
    return ConsoleTranslate.get("console.command.native");
  }
  ...
  public void execute(String commandText) throws Exception
  {
    ...
    Process proc = rt.exec(commandText.trim());
    proc.waitFor();
    BufferedReader in = new BufferedReader(new InputStreamReader(proc
        .getInputStream()));
    String line;
    while ((line = in.readLine()) != null)
      console.println(ConsoleTranslate.get("console.command.native.output",
          line));
  }
}