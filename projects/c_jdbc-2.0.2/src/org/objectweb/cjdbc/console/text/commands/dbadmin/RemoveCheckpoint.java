 ...
 * @version 1.0
 */
public class RemoveCheckpoint extends AbstractAdminCommand
{
   ...
   */
  public RemoveCheckpoint(VirtualDatabaseAdmin module)
  {
    super(module);
  }
  ...
  {
    jmxClient.getVirtualDatabaseProxy(dbName, user, password).removeCheckpoint(
        commandText.trim());
  }
  ...
  {
    return ConsoleTranslate.get("admin.command.removeCheckpoint");
  }
