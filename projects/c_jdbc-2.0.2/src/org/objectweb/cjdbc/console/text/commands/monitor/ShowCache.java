 ...
 * @version 1.0
 */
public class ShowCache extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowCache.java</code> object
   * 
   * @param module monitor module
   */
  public ShowCache(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy().retrieveCacheData(
        currentTarget), new CacheViewer(null));
  }
  ...
  public String getCommandDescription()
  {
    ...
    return ConsoleTranslate.get("monitor.command.cache");
  }
