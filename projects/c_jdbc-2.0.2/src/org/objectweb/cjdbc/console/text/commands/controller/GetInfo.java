 ...
 * @version 1.0
 */
public class GetInfo extends ConsoleCommand
{

  /**
   * Creates a new <code>GetInfo.java</code> object
   * 
   * @param module the command is attached to
   */
  public GetInfo(AbstractConsoleModule module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws Exception
  {
    try
    {
      console.println(XmlTools.applyXsl(
          jmxClient.getControllerProxy().getXml(), "c-jdbc-controller.xsl"));
    }
    catch (Exception e)
    {
      throw new ConsoleException(ConsoleTranslate.get(
          "controller.command.getInfo.failed", e));
    }
  ...
  {
    return ConsoleTranslate.get("controller.command.getInfo");
  }
