...
public class ListDatabases extends ConsoleCommand
{
  ...
  public void parse(String commandText) throws Exception
  {
    try
    {
      ArrayList list = jmxClient.getControllerProxy().getVirtualDatabaseNames();
    ...
    catch (Exception e)
    {
      throw new ConsoleException(ConsoleTranslate.get(
          "controller.command.listDatabases.failed", e));
    }
  }
  ...
  {
    return ConsoleTranslate.get("controller.command.listDatabases");
  }
