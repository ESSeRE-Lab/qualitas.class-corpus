...
public class SetFetchSize extends ConsoleCommand
{
  ...
  public void parse(String commandText) throws IOException, ConsoleException
  {
    try
    {
      ...
      console.println(ConsoleTranslate.get("sql.command.fetchsize.value",
          fetchsize));
    }
  ...
  {
    return ConsoleTranslate.get("sql.command.fetchsize.params");
  }
  ...
  {
    return ConsoleTranslate.get("sql.command.fetchsize.description");
  }
}