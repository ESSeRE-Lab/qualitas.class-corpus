 ...
 * @version 1.0
 */
public class ShowScheduler extends AbstractMonitorCommand
{

  /**
   * Creates a new <code>ShowScheduler.java</code> object
   * 
   * @param module the monitor module
   */
  public ShowScheduler(MonitorConsole module)
  {
    super(module);
  }
  ...
  {
    console.showInfo(jmxClient.getDataCollectorProxy().retrieveSchedulerData(currentTarget),
        new SchedulerViewer(null));
  }
  ...
  {
    return ConsoleTranslate.get("monitor.command.scheduler");
  }
