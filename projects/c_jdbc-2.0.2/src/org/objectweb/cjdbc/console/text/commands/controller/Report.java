 ...
 * @version 1.0
 */
public class Report extends ConsoleCommand
{

  /**
   * Creates a new <code>Report.java</code> object
   * 
   * @param module the command is attached to
   */
  public Report(AbstractConsoleModule module)
  {
    super(module);
  }
  ...
  public void parse(String commandText) throws Exception
  {
    if (commandText == null || commandText.equalsIgnoreCase(""))
    {
      ...
      console.println(jmxClient.getControllerProxy().generateReport());
    }
    else
    {
      // Write to file
  ...
  {
    return ConsoleTranslate.get("controller.command.generateReport");
  }
