 ...
 * @version 1.0
 */
public class GuiInputBackupFrame extends JDialog
    implements
      WindowListener,
      WindowStateListener
{
   ...
   */
  public GuiInputBackupFrame(Frame owner, String[] entries,
      ActionListener listener) throws HeadlessException
  {
    super(owner, GuiTranslate.get("frame.backup.title"), true);
    ...
    optionConfirm.setActionCommand(GuiCommands.COMMAND_HIDE_BACKUP_FRAME);
    ...
    Border listPanelBorder = BorderFactory.createTitledBorder(GuiTranslate
        .get("frame.backup.list"));
    listPanel.setBorder(listPanelBorder);
    listPanel.add(listPane);
    content.add(listPanel, BorderLayout.CENTER);
    JLabel valueLabel = new JLabel(GuiTranslate.get("frame.backup.selection"));
