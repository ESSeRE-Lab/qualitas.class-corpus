 ...
 * @version 1.0
 */
public class DatabasesViewer extends InfoViewer
{
   ...
   */
  public DatabasesViewer(Object[][] data)
  {
    super(data);
  }
  ...
  public String[] getColumnNames()
  {
    ...
    columnNames[0] = Translate.get("console.infoviewer.database.column.0");
    columnNames[1] = Translate.get("console.infoviewer.database.column.1");
    columnNames[2] = Translate.get("console.infoviewer.database.column.2");
    columnNames[3] = Translate.get("console.infoviewer.database.column.3");
    return columnNames;
  }
  ...
  {
    frameTitle = Translate.get("console.infoviewer.database.frame.title");
    infoViewerMenuBarString = Translate
        .get("console.infoviewer.database.menubar");
    actionToolTipText = Translate
        .get("console.infoviewer.database.action.tooltiptext");
    actionErrorMessage = Translate
        .get("console.infoviewer.database.action.error.message");
    actionSuccessMessage = Translate
        .get("console.infoviewer.database.action.success.message");
