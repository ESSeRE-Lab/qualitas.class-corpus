...
public final class Translate extends I18N
{
  /**
   * The base path to get translated sentence from.
   */
  public static final String   CJDBC_LANGUAGE_FILE = "c-jdbc-language";
  ...
  static
  {
    try
    {
      bundle = ResourceBundle.getBundle(CJDBC_LANGUAGE_FILE);
    }
