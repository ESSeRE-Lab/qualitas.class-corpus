...
public final class MonitorTranslate extends I18N
{

  /**
   * GUI message description is stored in a different file
   */
  public static final String   GUI_LANGUAGE_FILE = "c-jdbc-monitoring-language";
  ...
  static
  {
    try
    {
      bundle = ResourceBundle.getBundle(GUI_LANGUAGE_FILE);
    }
