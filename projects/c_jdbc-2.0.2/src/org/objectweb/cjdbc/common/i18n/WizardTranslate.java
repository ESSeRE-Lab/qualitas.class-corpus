...
public final class WizardTranslate extends I18N
{
  /**
   * Wizard message description is stored in a different file
   */
  public static final String   MBEANS_LANGUAGE_FILE = "c-jdbc-wizard";
