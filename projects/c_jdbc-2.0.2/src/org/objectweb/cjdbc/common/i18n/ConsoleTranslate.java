...
/**
 * This class defines a ConsoleTranslate
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inria.fr">Nicolas Modrzyk </a>
 * @version 1.0
 */
public final class ConsoleTranslate extends I18N
{
  /**
   * GUI message description is stored in a different file
   */
  public static final String   CONSOLE_LANGUAGE_FILE = "c-jdbc-console-language";
  ...
  static
  {
    try
    {
      bundle = ResourceBundle.getBundle(CONSOLE_LANGUAGE_FILE);
    }
