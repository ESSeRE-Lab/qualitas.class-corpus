...
/**
 * Count total of threads used by a <code>VirtualDatabase</code>
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inrialpes.fr">Nicolas Modrzyk</a>
 */
public class DatabaseThreadsCollector
    extends AbstractVirtualDatabaseDataCollector
{

  private static final long serialVersionUID = 4493564478281769842L;
   ...
   */
  public DatabaseThreadsCollector(String virtualDatabaseName)
  {
  ...
  {
    return ((VirtualDatabase) database).getCurrentNbOfThreads();
  }
