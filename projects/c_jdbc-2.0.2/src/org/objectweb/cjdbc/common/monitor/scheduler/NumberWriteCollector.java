...
/**
 * Return total of writes made on this <code>AbstractScheduler</code>
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inrialpes.fr">Nicolas Modrzyk</a>
 */
public class NumberWriteCollector extends AbstractSchedulerDataCollector
{

  private static final long serialVersionUID = -6179175482578424954L;
   ...
   */
  public NumberWriteCollector(String virtualDatabaseName)
  {
  ...
  {
    return ((AbstractScheduler) scheduler).getNumberWrite();
  }
