...
/**
 * Return total requests made on this <code>AbstractScheduler</code>
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inrialpes.fr">Nicolas Modrzyk</a>
 */
public class NumberRequestsCollector extends AbstractSchedulerDataCollector
{

  private static final long serialVersionUID = 3669739041738982333L;
   ...
   */
  public NumberRequestsCollector(String virtualDatabaseName)
  {
  ...
  {
    AbstractScheduler sch = ((AbstractScheduler) scheduler);
    return sch.getNumberRead() + sch.getNumberWrite();
  }
