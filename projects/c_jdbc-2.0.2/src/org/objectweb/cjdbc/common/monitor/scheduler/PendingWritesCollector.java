...
/**
 * Return pending writes for this <code>AbstractScheduler</code>
 * 
 * @author <a href="mailto:Nicolas.Modrzyk@inrialpes.fr">Nicolas Modrzyk</a>
 */
public class PendingWritesCollector extends AbstractSchedulerDataCollector
{

  private static final long serialVersionUID = 2073503605313469684L;
   ...
   */
  public PendingWritesCollector(String virtualDatabaseName)
  {
  ...
  {
    return ((AbstractScheduler) scheduler).getPendingWrites();
  }
