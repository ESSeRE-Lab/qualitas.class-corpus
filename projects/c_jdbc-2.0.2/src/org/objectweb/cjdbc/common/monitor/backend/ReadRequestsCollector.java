 ...
 */
public class ReadRequestsCollector extends AbstractBackendDataCollector
{
  private static final long serialVersionUID = 4891222146267148055L;
   ...
   */
  public ReadRequestsCollector(String backendName, String virtualDatabaseName)
  {
  ...
  {
    return ((DatabaseBackend) backend).getTotalReadRequest();
  }
