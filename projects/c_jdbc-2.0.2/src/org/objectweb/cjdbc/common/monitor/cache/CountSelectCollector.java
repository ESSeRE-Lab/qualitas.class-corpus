 ...
 */
public class CountSelectCollector extends AbstractCacheStatsDataCollector
{
  private static final long serialVersionUID = 1234123218190869192L;
   ...
   */
  public CountSelectCollector(String virtualDatabaseName)
  {
  ...
  {
    return ((AbstractResultCache) cache).getCacheStatistics().getSelect();
  }
