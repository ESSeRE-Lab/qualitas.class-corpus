 ...
 */
public class CountHitsCollector extends AbstractCacheStatsDataCollector
{
  private static final long serialVersionUID = -7931884361659696247L;
   ...
   */
  public CountHitsCollector(String virtualDatabaseName)
  {
  ...
  {
    return ((AbstractResultCache) cache).getCacheStatistics().getHits();
  }
