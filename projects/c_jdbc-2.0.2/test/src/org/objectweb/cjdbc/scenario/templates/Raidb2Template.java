 ...
 * @version 1.0
 */
public abstract class Raidb2Template extends SimpleRaidb2Template
{
  protected ControllerManager cm = new ControllerManager();
  protected DatabaseManager hm = new DatabaseManager();
  protected Process hm1 = null,hm2 = null;
  ...
  protected void setUp()
  {
    try
    {
      cm.loaddatabase(""+controller.getPortNumber(),"hsqldb-raidb2.xml");
