 ...
 * @version 1.0
 */
public class HorizontalWithRecoveryScenario extends HorizontalTemplate
{

  /**
   * There was a problem with the recovery log in horizontal setups, with sharing and
   * sending not serializable information.
   * 
