 ...
 * @version 1.0
 */
public abstract class HorizontalWithRecoveryTemplate extends
    SimpleHorizontalTemplate
{

  protected ComponentInterface hm5 = null, hm6 = null;
  ...
  protected void setUp()
  {
    ...
    try
    {
      ...
      super.setDatabasesUp("hsqldb-raidb1-distribution-recovery");
    }
    catch (Exception e)
    {
      e.printStackTrace();
