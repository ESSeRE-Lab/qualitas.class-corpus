 ...
 * @version 1.0
 */
public abstract class OneHundredTablesRaidb1Template extends Template
{
  ...
  protected void setUp()
  {
    ...
    {
      hm1 = hm.start("9001");
      hm1.loadDatabase("database-raidb1-100-tables.template");
      hm2 = hm.start("9002");
      hm2.loadDatabase("database-raidb1-100-tables.template");
